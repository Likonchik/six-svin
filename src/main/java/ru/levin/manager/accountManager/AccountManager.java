...
public class AccountManager implements IMinecraft {
    ...
    private final File file = new File(Minecraft.getInstance().gameDirectory, "files/alts.ew");
    private final File lastAltFile = new File(Minecraft.getInstance().gameDirectory, "files/lastAlt.ew");
