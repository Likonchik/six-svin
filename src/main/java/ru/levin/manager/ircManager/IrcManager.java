...
public class IrcManager {
    ...
    private final String cheatName = "OneTap";
    ...
    public void messageClient(String string) {
        ...
        mc.gui.getChat().addMessage(applyGradient(string));
        addMessage(string);
    }

    private Component applyGradient(String string) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            component.append(Component.literal(String.valueOf(prefix.charAt(i))).setStyle(Style.EMPTY.withColor(TextColor.fromRgb(rgb))));
        }

        if (!rest.isEmpty()) {
            component.append(Component.literal(rest).setStyle(Style.EMPTY.withColor(TextColor.fromRgb(0xFFFFFF))));
        }
