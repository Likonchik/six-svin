...
public class FunctionManager {
    ...
    public final AntiScreenshot antiScreenshot;
    ...
    public final NoRecoil noRecoil;
    public final GunAimbot gunAimbot;
