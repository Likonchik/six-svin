...
public class DeathCoords extends Function {
        ...
        if (event instanceof EventUpdate) {
            if (isPlayerDead()) {
                ...
                if (mc.player.deathTime < 1) {
                    String message = "Координаты: " + ChatFormatting.GRAY + "X: " + positionX + " Y: " + positionY + " Z: " + positionZ + ChatFormatting.RESET;
    ...
    private boolean isPlayerDead() {
        return mc.player.getHealth() < 1.0f && mc.screen instanceof DeathScreen;
    }
}
