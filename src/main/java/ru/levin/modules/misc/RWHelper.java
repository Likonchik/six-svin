...
public class RWHelper extends Function {
    ...
    public void onEvent(Event event) {
        ...
        boolean noForward = mc.player.zza == 0 && !mc.options.keyLeft.isDown() && !mc.options.keyRight.isDown();

        if (mc.options.keyJump.isDown()) y = noForward ? 0.5F : 0.25F;
        else if (mc.options.keyShift.isDown()) y = noForward ? -0.5F : -0.25F;
