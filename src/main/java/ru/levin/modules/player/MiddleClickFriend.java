                ...
                if (mc.hitResult instanceof EntityHitResult entityHitResult) {
                    if (entityHitResult.getEntity() instanceof Player player) {
                        ...
                        if (Manager.FRIEND_MANAGER.isFriend(name)) {
                            ...
                            ClientManager.message(ChatFormatting.GRAY + name + ChatFormatting.RED + " удалён из друзей");
                        } else {
                            Manager.FRIEND_MANAGER.addFriend(name);
                            ClientManager.message(ChatFormatting.GRAY + name + ChatFormatting.GREEN + " добавлен в друзья");
                        }
                    }
                }
            }
