...
public class ColorUtilTest {
    ...
    private final boolean CLEANER_STARTED = startCleaner();

    private boolean startCleaner() {
    ...
    // Explicit (no Lombok) to stay robust against @UtilityClass nested-class processing.
    private static final class ColorKey {
        final int red, green, blue, alpha;
        ColorKey(int red, int green, int blue, int alpha) {
            this.red = red; this.green = green; this.blue = blue; this.alpha = alpha;
        }
        @Override public boolean equals(Object o) {
            if (this == o) return true;
            if (!(o instanceof ColorKey)) return false;
            ColorKey k = (ColorKey) o;
            return red == k.red && green == k.green && blue == k.blue && alpha == k.alpha;
        }
        @Override public int hashCode() {
            return java.util.Objects.hash(red, green, blue, alpha);
        }
    }

    private static final class CacheEntry implements Delayed {
        ...
        public ColorKey getKey() { return key; }
